...
@SuppressLint("NewApi")
//public class BluetoothSPP implements Parcelable {
...
//    }
//
//    protected BluetoothSPP(Parcel in) {
//        mDeviceName = in.readString();
//        mDeviceAddress = in.readString();
//        isAutoConnecting = in.readByte() != 0;
//        isAutoConnectionEnabled = in.readByte() != 0;
//        isConnected = in.readByte() != 0;
//        isConnecting = in.readByte() != 0;
//        isServiceRunning = in.readByte() != 0;
//        keyword = in.readString();
//        isAndroid = in.readByte() != 0;
//        c = in.readInt();
//    }
//
//    public static final Creator<BluetoothSPP> CREATOR = new Creator<BluetoothSPP>() {
//        @Override
//        public BluetoothSPP createFromParcel(Parcel in) {
//            return new BluetoothSPP(in);
//        }
//
//        @Override
//        public BluetoothSPP[] newArray(int size) {
//            return new BluetoothSPP[size];
//        }
//    };
//
//    @Override
...
//        dest.writeByte((byte) (isAutoConnectionEnabled ? 1 : 0));
//        dest.writeByte((byte) (isConnected ? 1 : 0));
//        dest.writeByte((byte) (isConnecting ? 1 : 0));
//        dest.writeByte((byte) (isServiceRunning ? 1 : 0));
//        dest.writeString(keyword);
//        dest.writeByte((byte) (isAndroid ? 1 : 0));
//        dest.writeInt(c);
//    }
//
